          ...
          <div className="admin-form-card">
            ...
            <div className="admin-form-grid">
              ...
              <div className="admin-form-group">
                ...
                <select name="category" className="admin-form-select" value={form.category} onChange={handleChange} title="Danh mục sản phẩm" aria-label="Danh mục sản phẩm">
              ...
              <div className="admin-form-group admin-form-full">
                <label className="admin-form-label">Tùy chọn</label>
